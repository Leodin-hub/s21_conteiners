...
template <typename T> Stack<T>::Stack(const Stack &other) : Stack() {
...
template <typename T> void Stack<T>::StackCopy_(const Stack<T> &other) {
  this->clear();
...
template <typename T> typename Stack<T>::const_reference Stack<T>::front() {
...
template <typename T> typename Stack<T>::const_reference Stack<T>::back() {
...
template <typename T> bool Stack<T>::empty() const { return this->size_ == 0; }
...
template <typename T> typename Stack<T>::Nodes *Stack<T>::getFirst() {
  return this->first_;
}

template <typename T> typename Stack<T>::Nodes *Stack<T>::getLast() {
  return this->last_;
}

template <typename T> void Stack<T>::setFirst(Nodes *ptr) {
  if (ptr != nullptr) {
...
template <typename T> void Stack<T>::setLast(Nodes *ptr) {
  if (ptr != nullptr) {
...
template <typename T> void Stack<T>::setSize(size_t size) {
  if (size > 0) {
    if (size > this->size_) {

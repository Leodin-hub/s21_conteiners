...
template <typename Key, typename T> void Map<Key, T>::Node::PrintNode() {
...
template <typename Key, typename T> bool Map<Key, T>::Node::IsParent() {
  return this == this->parent->left;
}

template <typename Key, typename T>
typename Map<Key, T>::Node **
Map<Key, T>::Node::LeftOrRightSun(const bool left) {
